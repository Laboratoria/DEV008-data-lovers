...
const contenedorDePortadas = document.getElementById ("animaciones");//para vincular el primer contenedor con el DOM
...
function pintarPosters(listaDePeliculas) { //estoy pintando los posters para eso es la función
  for (let index = 0; index < listaDePeliculas.length; index++) {
    ...
    document.getElementById("animaciones").appendChild(caja);
  }
  return
