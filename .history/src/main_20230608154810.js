...
function pintarPosters(listaDePeliculas) { //estoy pintando los posters para eso es la función
  ...
  /*
  function creandoTarjeta (tarjetaModal){
    dataModal.innerHTML = "";

    for (const gModal of tarjetaModal){
      const ghibliModal = document.createElement ("div");
      ghibliModal.setAttribute ("class","modal_container");
      ghibliModal.
