import {orderData, orderData2, filtroDir,filtroProduc} from '../src/data.js';
...
describe('filtroDir', () => { 
  ...
  it('return director',  () => { //le decimos que va a ser 
    expect(filtroDir(directoresTest)).toEqual( [
      {director: "Hiroyuki Morita"},
      {director: "Hiromasa Yonebayashi"},
      {director: "Yoshifumi Kondō"},
      {director: "Hayao Miyazaki"},
...
describe('filtroProduc', () => { 
  ...
  it('return producer',  () => { //le decimos que va a ser 
    expect(filtroProduc(producerTest)).toEqual( [
      {producer: "Isao Takahata"},
      {producer: "Toshio Suzuki"},
      {producer: "Toru Hara"},
      {producer: "Hayao Miyazaki"},
  ...
  it('return producer',  () => { //le decimos que va a ser 
    expect(filtroProduc(producerTest)).toEstrictEqual( [
      {producer: "Hayao Miyazaki"},
      {producer: "Yoshiaki Nishimura"},
      {producer: "Isao Takahata"},
      {producer: "Toshio Suzuki"},
